...
public class UpdatePayment extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jButton1.setText("Remove Amount");
        ...
        jLabel12.setText("Update Payment");
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        db.rs=db.stmt.executeQuery("Select Paid from Payments where ID='"+cms+"'");
        while(db.rs.next()){
         a = db.rs.getInt(1);
            System.out.println(a);
        }
        amount=a+amount;
        int Remain = amount-3000;
            System.out.println(amount);
            System.out.println(Remain);
        db.stmt.executeUpdate("Update Payments set Paid='"+amount+"' , Remaining='"+Remain+"' where ID='"+cms+"' ");
        JOptionPane.showMessageDialog(null,"Amount is added!");
        jTextField3.setText("");
        jTextField1.setText("");
        }catch(Exception ex){
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        int Remain = amount-3000;
            ...
            System.out.println(Remain);
        db.stmt.executeUpdate("Update Payments set Paid='"+amount+"' , Remaining='"+Remain+"' where ID='"+cms+"' ");
        JOptionPane.showMessageDialog(null,"Amount is deducted!");
