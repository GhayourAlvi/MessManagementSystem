...
public class AddNewMember extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel10.setText("Insert New Record");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
       ...
       db.stmt.executeUpdate("insert into Member (F_Name , L_Name , ID ,  Room_No , Semester , Department ) values ('"+fname+"','"+lname+"','"+CMS+"','"+room+"','"+Semester+"','"+Dept+"')" ); 
       ...
       jTextField6.setText("");
           ...
           JOptionPane.showMessageDialog(null,"CMS is Already Inserted");
