...
public class AddUnits extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        String CMS = jTextField1.getText();
        String BF = jTextField2.getText();
        int bfast = Integer.parseInt(BF);
        String Lunch = jTextField3.getText();
        int lunch = Integer.parseInt(Lunch);
        String Dinner = jTextField5.getText();
        int dinner = Integer.parseInt(Dinner);
        
        try{
                Database db = new Database();
                db.stmt.executeUpdate("insert into Units (Unit_Date,ID, B_fast, Lunch, Dinner ) values ('"+Date+"','"+CMS+"','"+bfast+"','"+lunch+"','"+dinner+"')" ); 
                JOptionPane.showMessageDialog(null,"Units are added!");
                jTextField1.setText("");
                jTextField2.setText("");
                jTextField3.setText("");
        ...
        JOptionPane.showMessageDialog(null,"Units are added already!");
         jTextField1.setText("");
                jTextField2.setText("");
                jTextField3.setText("");
