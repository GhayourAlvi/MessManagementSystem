...
public class DailyBill extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel12.setText("Daily Bill Details");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
       ...
       db.rs=db.stmt.executeQuery("Select Paid_to_cook , Bill , Remaining from Expenses where Expense_Date='"+date+"'");
       while(db.rs.next()){
        Paid=db.rs.getInt(1);
        Bill=db.rs.getInt(2);
        Remain=db.rs.getInt(3);
jTextField2.setText(""+Paid+"");
jTextField4.setText(""+Bill+"");
jTextField3.setText(""+Remain+"");
       }
       }catch(Exception ex){
