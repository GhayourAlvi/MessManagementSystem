...
public class AddNewPayment extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel12.setText("Add New Payment");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        int Remaining  = Paid-3000;
        int Total = 3000;
        try{
        Database db = new Database();
        db.stmt.executeUpdate("insert into Payments (ID,Total_Amount , Paid,Remaining) values ('"+cms+"','"+Total+"','"+Paid+"','"+Remaining+"')");
        JOptionPane.showMessageDialog(null,"Amount is Inserted");
        jTextField1.setText("");
        jTextField3.setText("");
        }
        catch(Exception exx){
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AddNewPayment.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
